...
export interface AmbientLightProps extends ObjectProps {
  color?: number | Color | string;
  intensity?: number;
}

export default class AmbientLightObject extends Object {
  ...
  public constructor(props: AmbientLightProps = {}) {
    super(props);
